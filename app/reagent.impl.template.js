...
var G__12190 = o;
reagent.impl.template.goog$module$goog$object.set(G__12190,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__12313__delegate = function (args){
...
while (G__12314__i < G__12314__a.length) {G__12314__a[G__12314__i] = arguments[G__12314__i + 0]; ++G__12314__i;}
  args = new cljs.core.IndexedSeq(G__12314__a,0,null);
} 
return G__12313__delegate.call(this,args);};
G__12313.cljs$lang$maxFixedArity = 0;
G__12313.cljs$lang$applyTo = (function (arglist__12316){
var args = cljs.core.seq(arglist__12316);
return G__12313__delegate(args);
});
...
var G__12197 = o;
reagent.impl.template.goog$module$goog$object.set(G__12197,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__12321__i < G__12321__a.length) {G__12321__a[G__12321__i] = arguments[G__12321__i + 0]; ++G__12321__i;}
  args = new cljs.core.IndexedSeq(G__12321__a,0,null);
} 
...
var G__12198 = props;
var G__12198__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12198,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12198);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12198__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12202 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12202,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12202;
}
})(),id_class);
...
var G__12207 = (cljs.core.count(argv) - first_child);
switch (G__12207) {
case (0):
...
var vec__12216 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12216,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12216,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12216,(2),null);
...
var temp__5808__auto___12342 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12342 == null)){
} else {
var key_12344 = temp__5808__auto___12342;
(jsprops.key = key_12344);
}
...
var temp__5808__auto___12348 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12348 == null)){
} else {
var key_12349 = temp__5808__auto___12348;
...
var temp__5808__auto___12358 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12358 == null)){
} else {
var key_12360 = temp__5808__auto___12358;
(jsprops.key = key_12360);
}
...
var temp__5808__auto___12397 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12397 == null)){
} else {
var key_12399 = temp__5808__auto___12397;
...
var temp__5808__auto___12400 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12400 == null)){
} else {
var key_12402 = temp__5808__auto___12400;
(jsprops.key = key_12402);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12259_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12259_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12268 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12268,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12268,(1),null);
...
break;
default:
var G__12410 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12411 = compiler;
v = G__12410;
compiler = G__12411;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template12294 = (function (opts,id,fn_to_element,parse_fn,meta12295){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12294.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12296,meta12295__$1){
var self__ = this;
var _12296__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12294(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12295__$1));
}));

(reagent.impl.template.t_reagent$impl$template12294.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12296){
var self__ = this;
var _12296__$1 = this;
return self__.meta12295;
}));

(reagent.impl.template.t_reagent$impl$template12294.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12294.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12294.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12294.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12294.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12294.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12295","meta12295",-2051828338,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12294.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12294.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12294");

(reagent.impl.template.t_reagent$impl$template12294.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template12294");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12294.
 */
reagent.impl.template.__GT_t_reagent$impl$template12294 = (function reagent$impl$template$__GT_t_reagent$impl$template12294(opts,id,fn_to_element,parse_fn,meta12295){
return (new reagent.impl.template.t_reagent$impl$template12294(opts,id,fn_to_element,parse_fn,meta12295));
});
...
return (new reagent.impl.template.t_reagent$impl$template12294(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
