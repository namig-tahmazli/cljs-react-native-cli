...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13489 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_13489(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13495 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13495(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13501 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13501(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13503 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13503(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13509 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13509(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13512 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13512(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13479,callback){
var map__13480 = p__13479;
var map__13480__$1 = cljs.core.__destructure_map(map__13480);
var input = map__13480__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13480__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13480__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
