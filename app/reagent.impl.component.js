...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11997 = c;
var G__11997__$1 = (((G__11997 == null))?null:G__11997.prototype);
if((G__11997__$1 == null)){
return null;
} else {
return G__11997__$1.reagentRender;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__12010 = c;
var G__12010__$1 = (((G__12010 == null))?null:G__12010.constructor);
if((G__12010__$1 == null)){
return null;
} else {
return G__12010__$1.displayName;
}
})();
...
var G__12011 = c;
var G__12011__$1 = (((G__12011 == null))?null:G__12011.constructor);
if((G__12011__$1 == null)){
return null;
} else {
return G__12011__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__12013 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12014 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12014);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12013);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__12027 = key;
var G__12027__$1 = (((G__12027 instanceof cljs.core.Keyword))?G__12027.fqn:null);
switch (G__12027__$1) {
...
var c = this;
var G__12039_12166 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12039_12166 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12039_12166);
}
...
var renders_12167 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12168 = cljs.core.first(cljs.core.vals(renders_12167));
...
if((cljs.core.count(renders_12167) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12167))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12168)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12168], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12094 = o;
reagent.impl.component.goog$module$goog$object.set(G__12094,cljs.core.name(k),v);
...
return (function() { 
var G__12178__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__12179__i < G__12179__a.length) {G__12179__a[G__12179__i] = arguments[G__12179__i + 0]; ++G__12179__i;}
  args = new cljs.core.IndexedSeq(G__12179__a,0,null);
} 
return G__12178__delegate.call(this,args);};
G__12178.cljs$lang$maxFixedArity = 0;
G__12178.cljs$lang$applyTo = (function (arglist__12184){
...
var _STAR_current_component_STAR__orig_val__12130 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12131 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12131);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12130);
}});
...
var vec__12132 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12132,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12132,(1),null);
...
var G__12135 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__12135 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__12135);
}
});
}),[]);
