...
if((typeof root !== 'undefined') && (typeof root.root_comp_ref !== 'undefined')){
} else {
root.root_comp_ref = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null);
}
root.expo_root = (function root$expo_root(root__$1){
var is_first_call_QMARK_ = (cljs.core.deref(root.root_ref) == null);
cljs.core.reset_BANG_(root.root_ref,root__$1);

if((!(is_first_call_QMARK_))){
var temp__5804__auto__ = cljs.core.deref(root.root_comp_ref);
...
var this$ = this;
return cljs.core.reset_BANG_(root.root_comp_ref,this$);
}),new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814),(function (){
return cljs.core.reset_BANG_(root.root_comp_ref,null);
